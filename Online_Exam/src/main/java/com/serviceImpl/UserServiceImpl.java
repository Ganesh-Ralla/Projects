...
public class UserServiceImpl implements UserService {
    ...
    public void getyour_info(SessionFactory sf) {
        ...
        User user = s.get(User.class, id);
        if(user != null){
            System.out.println("user_id\t\tName\tUsername\temail\tPassword");
            System.out.println("----------------------------------------");
            System.out.println(user.getUserId()+"\t"+user.getFullname()+"\t"+user.getUsername()+"\t"+user.getEmail()+user.getPassword());
